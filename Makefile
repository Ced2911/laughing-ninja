...
#---------------------------------------------------------------------------------
LIBS	:=	-lxenon -lm -lfat -lavcodec -lavformat -lavutil -lswscale -lm    -lavcodec -lavformat -lavutil -lswscale -lm  -lxenon
...
install: $(BUILD) $(OUTPUT).a
	cp $(OUTPUT).a $(LIBXENON_LIB)
	mkdir -p $(LIBXENON_INC)/libcaps/
	cp $(SOURCES)/*.h $(LIBXENON_INC)/libcaps/
